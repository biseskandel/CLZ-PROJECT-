    ...
    <div class="grid gap-10 px-24 grid-cols-2">
        ...
        <div class="bg-gray-100 p-4 rounded-lg shadow flex justify-between">
            ...
            <div class="flex flex-col">
                <a href="actioncart.php?deleteid=<?php echo $rowcart['id'];?>" onclick="return confirm('Are you sure to remove from Cart?')" 
                ...
                <form action="actionorder.php" method="POST">
                    ...
                    <!-- <input type="hidden" name="product_id" value="<?php echo $rowprd['id']; ?>">
                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                    <input type="hidden" name="price" value="<?php echo $rowcprd['price']; ?>">
                    <input type="hidden" name="quantity" value="<?php echo $rowcprd['quantity']; ?>"> -->
                <button type="submit" name="buynow" class="bg-orange-500 text-black px-4 py-2 rounded-lg my-2">Buy Now</button>
                </form>
            </div>
        </div>
        <?php } ?>
